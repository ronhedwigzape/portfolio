...
<template>
    <button class="VPSwitch VPSwitchAppearance" type="button" role="switch" title="toggle dark mode" aria-checked="true" data-v-b23ca388="" data-v-9bfd86d6="" data-v-629fa0b6="">
        <span class="check">
            <span class="icon"><!--[-->
                ...
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 24 24" class="moon" data-v-9bfd86d6="">
